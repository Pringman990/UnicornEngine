...
GPUResourceHandle<GPUTexture> TextureManager::CreateTexture(const ByteBuffer& Buffer, const Vector3i& Extent, RenderFormat Format, TextureBindFlags Bind, TextureUsage Usage)
{
	const LogicalDevice& device = mRenderer->GetLogicalDevice();
