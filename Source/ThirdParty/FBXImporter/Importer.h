	...
	namespace FBX
	{
		...
		public:
			...
			*/
			 ...
			 */
			static FbxImportStatus LoadMeshW(const std::wstring& someFilePath, Mesh& outMesh, bool bRegenerateNormals = false, bool bMergeDuplicateVertices = true);
			 ...
			 * @returns True if the model was successfully loaded, otherwise false.
			 */
			static FbxImportStatus LoadMeshA(const std::string& someFilePath, Mesh& outMesh, bool bRegenerateNormals = false, bool bMergeDuplicateVertices = true);
			 ...
			 */
			static FbxImportStatus LoadAnimationW(const std::wstring& someFilePath, Animation& outAnimation);
			 ...
			 * @returns True if the animation was successfully loaded, otherwise false.
			 */
			static FbxImportStatus LoadAnimationA(const std::string& someFilePath, Animation& outAnimation);
			 ...
			 */
			static FbxImportStatus LoadNavMeshW(const std::wstring& someFilePath, NavMesh& outNavMesh, bool shouldTriangulate = false);
			 ...
			 * @param shouldTriangulate If import should triangulate the NavMesh, this will result in more polygons.
			 */
			static FbxImportStatus LoadNavMeshA(const std::string& someFilePath, NavMesh& outNavMesh, bool shouldTriangulate = false);
